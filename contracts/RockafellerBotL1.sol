...
contract RockafellerBotL1 is Ownable {
    ...
    constructor(uint256 _l2ContractAddress, ISwapRouter _swapRouter, IStarknetCore _starknetCore, IERC20 _usdc, IERC20 _dai) payable {
    ...
    function sellWEth(uint amount) private {
        ...
        dai.approve(address(swapRouter), amount+100000);
